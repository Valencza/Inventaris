                            ...
                            <div class="row">
                                <div class="col-lg mb-4 order-0">
                                    ...
                                    <div class="button-box">
                                        <div id="btn"></div>
                                        <button type="button" class="toggle-btn btn-sm active" id="siswaToggle">Siswa</button>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <form method="post" action="confirm.php">
                                                                                <input type="hidden" name="nama_siswa" value="<?= $row['nama_siswa'] ?>">
                                            ...
                                            <div class="modal fade" id="insertModalLong" tabindex="-1" role="dialog" aria-labelledby="insertModalLongTitle" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="needs-validation" novalidate id="siswaForm" action="insert_siswa.php" method="post" autocomplete="off">
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" list="nama_siswa_list" name="nama_siswa" id="nama_siswa" placeholder="Pilih Nama Siswa" required="">
                                                                            ...
                                                                            $(document).ready(function() {
                                                                                ...
                                                                                $.ajax({
                                                                                    ...
                                                                                    success: function(response) {
                                                                                        ...
                                                                                        studentNames.forEach(function(siswa) {
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input class="form-control" type="text" name="abjad" id="abjad">
                                                                    <div class="invalid-feedback">Harus Diisi</div>
                                                                </div><br>
                                                                <div class="form-group">
                                            ...
                                            <script>
                                                ...
                                                $(document).ready(function() {
                                                    ...
                                                    $('#submitButton').click(function() {
                                                        var formUrl = isSiswaForm ? '/inventaris/dashboard/peminjaman/siswa/index.php' : ($('#guruToggle').hasClass('active') ? '/inventaris/dashboard/peminjaman/guru/index.php' : '/inventaris/dashboard/peminjaman/luar_sekolah/index.php');
                                                        window.location.href = formUrl;
                                                    });

                                                    // Handle initial URL
                                                    var currentPath = window.location.pathname;
                                                    if (currentPath.includes('/inventaris/dashboard/peminjaman/guru/index.php')) {
                                                        $('#guruToggle').click();
                                                    } else if (currentPath.includes('/inventaris/dashboard/peminjaman/luar_sekolah/index.php')) {
