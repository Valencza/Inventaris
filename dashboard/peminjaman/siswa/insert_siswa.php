...
if (isset($_POST["submitinsert"])) {
    ...
    if ($result) {
        ...
        $insert_peminjaman = "INSERT INTO tbl_peminjaman (id_siswa, id_barang, waktu_pinjam, waktu_kembali, kondisi_sebelum, kondisi_sesudah) VALUES ('$id_siswa', '$id_barang', '$waktu_pinjam', '$waktu_kembali', '$kondisi_sebelum', '$kondisi_sesudah');";
