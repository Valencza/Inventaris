                            ...
                            <div class="row">
                                <div class="col-lg mb-4 order-0">
                                    ...
                                    <div class="button-box">
                                        ...
                                        <button type="button" class="toggle-btn btn-sm active" id="guruToggle">Guru</button>
                                        <button type="button" class="toggle-btn btn-sm" id="luarSekolahToggle">Luar Sekolah</button>
                                    </div>
                                        ...
                                        <div class="p-3 table-responsive">
                                            <table id="tabel-crud" class="table table-striped" style="width: 100%;">
                                                ...
                                                <tbody>
                                                    ...
                                                    JOIN
                                                        tbl_guru ON tbl_peminjaman.id_guru = tbl_guru.id_guru
                                                    ...
                                                    while ($row = mysqli_fetch_assoc($queryview)) :
                                                        ...
                                                        echo "<td id='status_peminjaman{$row['id_peminjaman']}'>" . $row['status'] . "</td>";
                                                    ?>
                                                        <td>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <form method="post" action="confirm.php">
                                                                                <input type="hidden" name="nama_guru" value="<?= $row['nama_guru'] ?>">
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form name="contact-form" action="delete.php" method="post">
                                                                            ...
                                                                            <p>Yakin untuk menghapus data dari Peminjam : <?= $row['nama_guru'] ?> ?</p>
                                            ...
                                            <div class="modal fade" id="insertModalLong" tabindex="-1" role="dialog" aria-labelledby="insertModalLongTitle" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="needs-validation" novalidate id="siswaForm" action="insert_guru.php" method="post" autocomplete="off">
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control" list="nama_guru_list" name="nama_guru" id="nama_guru" placeholder="Pilih Nama Guru" required="">
                                                                    <datalist id="nama_guru_list">
                                                                        <script>
                                                                            $(document).ready(function() {
                                                                                // Mengambil data nama siswa dari database
                                                                                $.ajax({
                                                                                    type: "POST",
                                                                                    url: "fetch_teacher_names.php",
                                                                                    success: function(response) {
                                                                                        var teacherNames = JSON.parse(response);
                                                                                        var datalist = document.getElementById('nama_guru_list');

                                                                                        teacherNames.forEach(function(siswa) {
                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    ...
                                                    $('#submitButton').click(function() {
                                                        var formUrl = isSiswaForm ? '/inventaris/dashboard/peminjaman/guru/index.php' : ($('#luarSekolahToggle').hasClass('active') ? '/inventaris/dashboard/peminjaman/luar_sekolah/index.php' : '/inventaris/dashboard/peminjaman/siswa/index.php');
                                                        window.location.href = formUrl;
                                                    });

                                                    // Handle initial URL
                                                    var currentPath = window.location.pathname;
                                                    if (currentPath.includes('/inventaris/dashboard/peminjaman/luar_sekolah/index.php')) {
                                                        $('#luarSekolahToggle').click();
                                                    } else if (currentPath.includes('/inventaris/dashboard/peminjaman/siswa/index.php')) {
                                                        $('#siswaToggle').click();
                                                    }
                                                });
                                            </script>
                                            ...
                                            <script>
                                                $('#nama_guru').change(function() {
                                                    ...
                                                    var dataListId = $(this).attr('data-nama-siswa') === 'true' ? 'nama_guru_list' : 'nama_guru_list';

                                                    $.ajax({
                                                        type: "POST",
                                                        url: "fetch_teacher_info.php",
                                                        data: {
                                                            teacherName: selectedName
                                                        },
                                                        success: function(response) {
                                                            var teacherData = JSON.parse(response);
                                                            $('#jabatan').val(teacherData.jabatan);
                                                            $('#nip').val(teacherData.nip);
                                                        }
                                                    });
                                                });
                                            </script>
