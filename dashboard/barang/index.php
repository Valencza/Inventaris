                                                ...
                                                <tbody>
                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td><img src='../../assets/img/barang/<?= $row['foto_barang'] ?>' alt='' width='130px' class='img-fluid'></td>
                                                            <td><span class="badge bg-label-<?php

                                                                                            if ($row['kondisi_sebelum'] == "Baik") {
                                                                                                echo "success";
                                                                                            } elseif ($row['kondisi_sebelum'] == "Rusak") {
                                                                                                echo "danger";
                                                                                            } else {
                                                                                                echo "warning";
                                                                                            }

                                                                                            ?>"><?= $row['kondisi_sebelum'] ?></span></td>
                                                            <td><span class="badge bg-label-<?php
                                                            ...
                                                            <td>
                                                                <div class="d-grid gap-2 col-8">
                                                                    <a href="detail.php?id=<?= $row['id_barang'] ?>" class="btn btn-sm btn-info"><i class="bi bi-pencil-square"></i> Detail</a>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form name="contact-form" action="delete.php" method="post">
                                                                            ...
                                                                            <input type="hidden" name="foto_barang" id="foto_barang" value="<?= $row['foto_barang'] ?>">
                                                                    </div>
                                                        ...
                                                        <div class="modal fade" id="modal<?= $no; ?>" tabindex="-1" role="dialog" aria-labelledby="modal<?= $no; ?>LongTitle" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form name="contact-form" enctype="multipart/form-data" action="edit.php" method="post" autocomplete="off">
                                                                            <?php
                                                                            $id = $row['id_barang'];
                                                                            ...
                                                                            ?>
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <div class="col-6 my-3">
                                                                                        <img src="../../assets/img/barang/<?= $row_edit['foto_barang'] ?>" alt="" width="100px">
                                                                                    </div>
                                                                                    <input class="form-control" type="file" name="foto_barang" id="foto_barang">
                                                                                </div><br>
                                                                                <div class="form-group">
                                                                                    <label for="lokasi">Lokasi : </label>
                                                                                    <select class="form-control" name="lokasi" id="lokasi" required="">
                                                                                        <option value="LAB 2D" <?= ($row['lokasi'] == 'LAB 2D') ? 'selected' : ''; ?>>LAB 2D</option>
                                                                                        <option value="LAB 3D" <?= ($row['lokasi'] == 'LAB 3D') ? 'selected' : ''; ?>>LAB 3D</option>
                                                                                        <option value="LAB ADVANCED" <?= ($row['lokasi'] == 'LAB ADVANCED') ? 'selected' : ''; ?>>LAB ADVANCED</option>
                                                                                        <option value="LAB MANUAL" <?= ($row['lokasi'] == 'LAB MANUAL') ? 'selected' : ''; ?>>LAB MANUAL</option>
                                                                                        <option value="LAB DDK 1" <?= ($row['lokasi'] == 'LAB DDK 1') ? 'selected' : ''; ?>>LAB DDK 1</option>
                                                                                        <option value="LAB DDK 2" <?= ($row['lokasi'] == 'LAB DDK 2') ? 'selected' : ''; ?>>LAB DDK 2</option>
                                                                                    </select>
                                                                                </div><br>
                                                                                <div class="form-group">
                                                                                    <label for="sumber">Sumber : </label>
                                                                                    <select class="form-control" name="sumber" id="sumber" required="">
                                                                                        <option value="BOS" <?= ($row['sumber'] == 'BOS') ? 'selected' : ''; ?>>BOS</option>
                                                                                        <option value="BPOP" <?= ($row['sumber'] == 'BPOP') ? 'selected' : ''; ?>>BPOP</option>
                                                                                        <option value="BLUD" <?= ($row['sumber'] == 'BLUD') ? 'selected' : ''; ?>>BLUD</option>
                                                                                        <option value="HIBAH" <?= ($row['sumber'] == 'HIBAH') ? 'selected' : ''; ?>>HIBAH</option>
                                                                                    </select>
                                                                                </div><br>
                                                                                <div class="form-group">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-select" name="kondisi_sebelum" id="kondisi_sebelum" required="">
                                                                                        ...
                                                                                        <option value="Pemeliharaan" <?= ($row['kondisi_sebelum'] == 'Pemeliharaan') ? 'selected' : ''; ?>>Pemeliharaan</option>
                                                                                        <option value="Perbaikan" <?= ($row['kondisi_sebelum'] == 'Perbaikan') ? 'selected' : ''; ?>>Perbaikan</option>
                                                                                    </select>
                                                                                </div><br>
                                                                                <div class="form-group">
                                            ...
                                            <div class="modal fade" id="insertModalLong" tabindex="-1" role="dialog" aria-labelledby="insertModalLongTitle" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="needs-validation" enctype="multipart/form-data" novalidate name="contact-form" action="insert.php" method="post" autocomplete="off">
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="foto_barang">Gambar : </label>
                                                                    <input class="form-control" type="file" name="foto_barang" id="foto_profile">
                                                                </div><br>
                                                                <div class="form-group">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-select" name="lokasi" id="lokasi" required="">
                                                                        <option value="" disabled selected hidden>--PILIH LOKASI BARANG--</option>
                                                                        <option value="Lab 2D">Lab 2D</option>
                                                                        <option value="Lab 3D">Lab 3D</option>
                                                                        <option value="Lab Advanced">Lab Advanced</option>
                                                                        <option value="Lab Manual">Lab Manual</option>
                                                                        <option value="Lab DDK 1">Lab DDK 1</option>
                                                                        <option value="Lab DDK 2">Lab DDK 2</option>
                                                                    </select>
                                                                    <div class="invalid-feedback">
                                                                        Harus Diisi
                                                                    </div>
                                                                ...
                                                                <div class="form-group">
                                                                    <label for="sumber">Sumber:</label>
                                                                    <select class="form-select" name="sumber" id="sumber" required="">
                                                                        <option value="" disabled selected hidden>--PILIH SUMBER BARANG--</option>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <select class="form-select" name="kondisi_sebelum" id="kondisi_sebelum" required="">
                                                                        ...
                                                                        <option value="Pemeliharaan">Pemiliharaan</option>
                                                                ...
                                                                <div class="form-group">
                                                                    <input class="form-control" type="hidden" name="status" id="status" value="Tersedia">
                                                                </div>
                                                        </div>
                                                        <div class="modal-footer">
                                                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
