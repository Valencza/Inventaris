...
?>
    ...
    <head>
        ...
        <title>Dashboard - Manage Guru</title>
                                            ...
                                            <table id="tabel-crud" class="table table-striped">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="col-2" scope="col">NIP</th>
                                                    ...
                                                    ?>
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        <form name="contact-form" action="delete.php" method="post">
                                                                            ...
                                                                            <p>Yakin untuk menghapus data dari Nama : <?= $row['nama_guru'] ?> ?</p>
                                                                            <input type="hidden" name="id_guru" id="id_guru" value="<?= $row['id_guru'] ?>">
                                                                    </div>
                                                        ...
                                                        <div class="modal fade" id="modal<?= $no; ?>" tabindex="-1" role="dialog" aria-labelledby="modal<?= $no; ?>LongTitle" aria-hidden="true">
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    <div class="modal-header">
                                                                        <h5 class="modal-title" id="modal<?= $no; ?>">Edit <?= $row['nama_guru'] ?></h5>
                                                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                                                                        </button>
                                                                    </div>
                                                                    <div class="modal-body">
                                                                        <form name="edit-form" action="edit.php" method="post">
                                                                            <?php
                                                                            $id = $row['id_guru'];
                                                                            $query_edit = "SELECT * FROM tbl_guru WHERE id_guru='$id'";
                                                                            $result = mysqli_query($connect, $query_edit);
                                                                            while ($row_edit = mysqli_fetch_assoc($result)) {
                                                                            ?>
                                                                                <div class="form-group">
                                                                                    <input class="form-control" type="hidden" name="id_guru" id="edit-id_guru" value="<?= $row['id_guru'] ?>" required="">
                                                                                </div>
                                                                                <div class="form-group">
                                                                                    <label for="edit-nama_guru">Nama Guru: </label>
                                                                                    <input class="form-control" type="text" name="nama_guru" id="edit-nama_guru" value="<?= $row['nama_guru']; ?>" required="">
                                                                                </div><br>
                                                                                <div class="form-group">
                                                                                    <label for="edit-jabatan">Jabatan: </label>
                                                                                    <input class="form-control" type="text" name="jabatan" id="edit-jabatan" value="<?= $row['jabatan']; ?>" required="">
                                                                                </div><br>
                                                                                <div class="form-group">
                                                                                    <label for="edit-nip">NIP : </label>
                                                                                    <input class="form-control" type="text" name="nip" id="edit-nip" value="<?= $row['nip']; ?>" required="">
                                                                                </div><br>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            ...
                                            <div class="modal fade" id="insertModalLong" tabindex="-1" role="dialog" aria-labelledby="insertModalLongTitle" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form class="needs-validation" novalidate name="contact-form" action="insert.php" method="post" autocomplete="off">
                                                                <div class="form-group">
                                                                    <input class="form-control" type="hidden" name="id_guru" id="id_guru" required="">
